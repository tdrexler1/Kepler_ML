...
x_cd_notransform = koi_df_factor[koi_df_factor$koi_pdisposition == "CANDIDATE", -1]
x_fp_notransform = koi_df_factor[koi_df_factor$koi_pdisposition == "FALSE POSITIVE", -1]
...
# Demonstrating effects of variable transfomration
...
```{r}
### MODEL SELECTION
## NOTE: the function call in this chunk can take 2+ hours to run; the pre-processed result is included in the commented line (572) below the call
